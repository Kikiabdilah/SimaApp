...
<body>
    ...
    <script type="text/javascript">
                ...
                success: function(a) {
                    ...
                    for (i = 0; i < a.length; i++) {
                        ...
                        html +=
                            ...
                            '<button style="' + aksi1 + '" class="btn btn-xs btn-info" onclick="aksi_usulan_kep(\'' + a[i].kd_usulan + '\', \'' + setuju + '\' )"><i class="fa fa-check"></i> Setuju</button> &nbsp;' +
                            '<button style="' + aksi1 + '" class="btn btn-xs btn-danger" onclick="aksi_usulan_kep(\'' + a[i].kd_usulan + '\', \'' + tolak + '\')"><i class="fa fa-times"></i> Tolak</button>' +
                            '<button style="' + aksi2 + '" type="button" class="btn btn-xs btn-success" disabled><i class="fa fa-check"></i> Disetujui</button>' +
        ...
        function aksi_usulan_kep(kd_usulan, stts_approval) {
            $.ajax({
                type: "POST",
                data: {
                    kd_usulan: kd_usulan,
                ...
                url: "<?= base_url('Pengadaan_aset/aksi_usulan_kep') ?>",
                async: false,
                dataType: "JSON",
                success: function(a) {
                    swal({
