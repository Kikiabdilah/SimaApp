                                ...
                                <form>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <textarea type="text" rows="2" class="form-control" name="nm_brg" id="nm_brg" required></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            <label for="jmlh_brg">Jumlah</label>
                                            <input type="number" class="form-control" name="jmlh_brg" id="jmlh_brg" placeholder="" required>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label for="harga_brg">Harga</label>
                                            <input type="number" class="form-control" name="harga_brg" id="harga_brg" placeholder="" required>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="satuan_brg">Satuan</label>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label for="masa_manfaat">Umur Ekonomis</label>
                                            <input type="text" class="form-control" name="masa_manfaat" id="masa_manfaat" placeholder="" required>
                                        </div>
                                        <div class="form-group col-md-6">
