...
class Kib_model extends CI_Model
{
    ...
    function get_dt_kib_a()
    {
        return $this->db->query(
            "SELECT 
                id_brg, kd_brg, nm_brg, thn_beli,thn_pengadaan, 
    ...
    function update_kib_a($id, $value, $modul)
    {
    ...
    //         $data = $this->db->query(
    //             "SELECT 
    //                 kd_brg, nm_brg, luas, YEAR(thn_pengadaan) AS thn_pengadaan, letak_lokasi,
    ...
    function get_dt_kib_c()
    {
        ...
        // return $this->db->query(
        //     "SELECT 
        //         id_brg, kd_brg, nm_brg, kondisi, ket
        //     FROM tbl_pengadaan_aset 
