...
class Pemeliharaan_aset extends CI_Controller
{
    ...
    {
        $this->load->view('Manager/pemeliharaan_aset');
    }

    public function pemeliharaan_aset_kep()
    {
        $this->load->view('Dirut/pemeliharaan_aset');
    }
    ...
    public function aksi_pelihara_wk()
    {
        ...
        $data               = $this->Pemeliharaan_aset_model->aksi_pemeliharaan_wk($id_pemeliharaan, $id_brg, $kd_matriks, $stts_approval, $nilai_buku_bln, $sisa_umr_ekonomis, $thn_beli);
        echo json_encode($data);
    }
