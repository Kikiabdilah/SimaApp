...
class Kib extends CI_Controller
{
    ...
    public function kib_a()
    {
        ...
        $data['kib_a'] = $this->Kib_model->get_dt_kib_a();
        $this->load->view('Aset/Kib/kib_a', $data);
    }
    ...
    {
        // $this->load->view('Manager/Kib/kib_a');
        $data['kib_a'] = $this->Kib_model->get_dt_kib_a();
        $this->load->view('Manager/Kib/kib_a', $data);
        // $this->load->view('Aset/Kib/kib_a', $data);
    }
    ...
    {
        $data['kib_b'] = $this->Kib_model->get_dt_kib_b();
        $this->load->view('Manager/Kib/kib_b', $data);
    }
    ...
    {
        $data['kib_c'] = $this->Kib_model->get_dt_kib_c();
        $this->load->view('Manager/Kib/kib_c', $data);
    }
    ...
    {
        $this->load->view('Manager/Kib/kib_e');
    }
    ...
    {
        // $this->load->view('Dirut/Kib/kib_a');
        $data['kib_a'] = $this->Kib_model->get_dt_kib_a();
        $this->load->view('Dirut/Kib/kib_a', $data);
    }
    ...
    {
        $data['kib_b'] = $this->Kib_model->get_dt_kib_b();
        $this->load->view('Dirut/Kib/kib_b', $data);
    }
    ...
    {
        $data['kib_c'] = $this->Kib_model->get_dt_kib_c();
        $this->load->view('Dirut/Kib/kib_c', $data);
    }
